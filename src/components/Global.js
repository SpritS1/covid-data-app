        ...
        <div className="global">
            ...
            <div className="global__data">
                <div className="global__data-left">
                    ...
                    <p className="global__data-value">21,391 <span className='global__data-new-value plus'>+2412</span></p>
                </div>
            ...
            <div className="global__data">
                <div className="global__data-left">
                    ...
                    <p className="global__data-value">594 <span className='global__data-new-value minus'>-10</span></p>
                </div>
                <div className="global__data-icon-box">
            ...
            <div className="global__data">
                <div className="global__data-left">
                    ...
                    <p className="global__data-value">15,343 <span className='global__data-new-value plus'>+1231</span></p>
                </div>
                <div className="global__data-icon-box">
